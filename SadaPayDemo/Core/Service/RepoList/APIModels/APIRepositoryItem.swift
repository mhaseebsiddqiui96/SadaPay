...
import Foundation
struct APIRepositoryItem : Codable {
	let id : Int?
	let node_id : String?
	let name : String?
	let full_name : String?
	let isPrivate : Bool?
	let owner : APIRepoOwner?
	let html_url : String?
	...
	init(from decoder: Decoder) throws {
		...
		owner = try values.decodeIfPresent(APIRepoOwner.self, forKey: .owner)
		...
		license = try values.decodeIfPresent(APIRepoLicense.self, forKey: .license)
